function ExportLibrary()
{
    ...
    $PlayniteApi.Database.Games | Select Id, Name, Source, ReleaseDate, Playtime, IsInstalled, InstallDirectory, Icon, Hidden | ConvertTo-Json | Out-File $full_path -Encoding utf8
